...
public class AxisView extends LinearLayout implements ChartModelListener {
    ...
    public AxisView(Context aContext) {
        ...
        TextView coords = new TextView(aContext);
        coords.setText("0,0");
